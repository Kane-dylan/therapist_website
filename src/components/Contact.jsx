...
const Contact = () => {
  ...
  return (
    <div className="bg-[#f3f0e8] py-16 px-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12">
          {/* Left Column: Contact Details */}
          <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
            <div className="p-8 h-full">
              <h2 className="text-3xl font-serif font-bold text-[#4a5a5b] mb-6">
                Contact Information
              </h2>

              <div className="space-y-4 text-[#4a5a5b]">
                <div>
                ...
                <div>
                  <p className="font-semibold font-sans">Office Hours:</p>
                ...
                <div>
                  <p className="font-semibold font-sans">Session Fees:</p>
                  <ul className="font-sans space-y-1">
                ...
                <div>
                  <p className="font-semibold font-sans">Specialties:</p>
                  <ul className="font-sans space-y-1">
          ...
          <div className="w-full lg:w-1/2 h-auto">
            <div className="bg-white rounded-lg border border-[#4a5a5b]/20 p-8 shadow-sm">
              <h1 className="text-3xl lg:text-4xl font-serif text-[#4a5a5b] mb-4 text-center font-bold">
                Get In Touch
              </h1>

              <p className="text-base font-sans text-[#4a5a5b] mb-6 text-center leading-relaxed">
              ...
              {!isClient ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-[#4a5a5b] font-sans font-medium mb-2"
                    >
                      Name
                    </label>
                    <input
                      ...
                      placeholder="Name"
                      className={`w-full px-4 py-3 border-2 rounded-md font-sans text-[#4a5a5b] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#9AB1B0] focus:border-transparent transition-colors ${
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className={`w-full px-4 py-3 border-2 rounded-md font-sans text-[#4a5a5b] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#9AB1B0] focus:border-transparent transition-colors resize-vertical ${
                  ...
                  <div className="flex items-start space-x-3">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="mt-1 w-5 h-5 text-[#9AB1B0] bg-gray-100 border-gray-300 rounded focus:ring-[#9AB1B0] focus:ring-2"
                    />
                    <label
                      htmlFor="agreeToContact"
                      className="text-[#4a5a5b] font-sans text-sm leading-relaxed"
                    >
                  ...
                  <button
                    ...
                    className={`w-full py-4 px-6 rounded-md font-sans font-semibold text-white text-lg transition-colors duration-200 ${
                      isSubmitting
                  ...
                  <div className="flex items-start space-x-2 pt-4">
                    <svg
                      className="w-5 h-5 text-[#4a5a5b] mt-0.5 flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                    ...
                    <p className="text-sm text-[#4a5a5b] font-sans">
